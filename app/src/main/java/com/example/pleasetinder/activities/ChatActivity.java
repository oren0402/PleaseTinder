...
import com.example.pleasetinder.adapters.ChatAdapter;
...
public class ChatActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textAvalability = findViewById(R.id.textAvailability);
    ...
    private void listenAvailabilityOfReceiver() {
        database.collection(Constants.KEY_COLLECTION_USERS).document(
            ...
            if(isReceiverAvailable) {
                textAvalability.setVisibility(View.VISIBLE);
            } else {
                textAvalability.setVisibility(View.GONE);
            }
    ...
    private void loadReceiverDetails() {
        ...
        textView.setText(receiverUser.name);
    }
